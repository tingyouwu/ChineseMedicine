...
public class BaseRecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseRecyclerViewHolder setOnClickListener(int viewId, BaseRecyclerViewAdapter.OnItemChildClickListener listener) {
        View view = getView(viewId);
    ...
    public BaseRecyclerViewHolder setOnLongClickListener(int viewId, BaseRecyclerViewAdapter.OnItemChildLongClickListener listener) {
        View view = getView(viewId);
        listener.mViewHolder = this;
